...
public class JsonToEdiDriverMarch implements Runnable {
    private final File ediFile;
    private final File jsonFile;

    public JsonToEdiDriverMarch(File jsonFile, File ediFile) {
    ...
    public static void main(String[] args) {
        ...
        final JsonToEdiDriverMarch driver = new JsonToEdiDriverMarch(new File(args[0]), new File(args[1]));
        try {
            driver.run();
        } catch (Exception e) {
